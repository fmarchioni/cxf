...
import org.apache.cxf.jaxrs.sse.servlet.sci.SseServletContainerInitializer;
...
public final class StatsServer {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        context.addServletContainerInitializer(new SseServletContainerInitializer(new CXFCdiServlet()), 
            Collections.singleton(Path.class));
